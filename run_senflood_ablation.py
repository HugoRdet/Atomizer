...
#TABLE1 = [(tpl, 1000) for tpl in range(1000, 6001, 500)]          # idx 0..10
#TABLE1 += [(64000,1000),(128000,1000)]
TABLE1=[]
TABLE2 = [(2000, ck) for ck in
...
TEST_SCRIPT = "script_test_senflood_density_skip.py"
