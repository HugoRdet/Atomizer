...
python3 script_train_baselines_flairhub.py --xp_name vit_pm_v1_spot_train --model vit_pm  --subset_indices ./data/FLAIR-HUB/subset_indices.json --use_vhr true --use_spot false  --use_dem true --use_s2 true --use_s1 true --multi_temporal 6 --epochs 30
python3 script_train_baselines_flairhub.py --xp_name vit_concat_v1_spot_train --model vit --subset_indices ./data/FLAIR-HUB/subset_indices.json  --use_vhr true --use_spot false  --use_dem true --use_s2 true --use_s1 true --multi_temporal 6  --epochs 30
python3 script_train_baselines_flairhub.py --xp_name resnet_pm_v1_spot_train  --model resnet_pm --resnet_variant resnet50 --subset_indices ./data/FLAIR-HUB/subset_indices.json --use_vhr true --use_spot false  --use_dem true --use_s2 true --use_s1 true --multi_temporal 6 --epochs 30
